...
var SearchActions = function () {
    function SearchActions() {
        ...
        this.generateActions('searchSuccess', 'searchFail', 'updateSearch', 'invalidSearch');
    }
    ...
    _createClass(SearchActions, [{
        ...
        value: function performSearch(search) {
            ...
            $.ajax({
                ...
                _this.actions.searchSuccess(data.message);
            }).fail(function (jqXhr) {
                _this.actions.searchFail(jqXhr.responseJSON.message);
            });
        }
    }]);
...
},{"./Footer":6,"./homepage/Commonbots":7,"./homepage/Search":8,"./homepage/Sidebar":9,"./uploadpage/Uploadform":11,"react":"react"}],6:[function(require,module,exports){
'use strict';
...
},{"../actions/FooterActions":2,"../stores/FooterStore":18,"react":"react","react-router":"react-router"}],7:[function(require,module,exports){
'use strict';
...
},{"./searchbox":10,"muicss/lib/react/input":57,"react":"react"}],8:[function(require,module,exports){
'use strict';
'bootstrap/dist/css/bootstrap.min.css';
...
var SearchBox = function (_Component) {
    ...
    _createClass(SearchBox, [{
        ...
        value: function handleSubmit(event) {
            ...
            if (!search) {
                _SearchActions2.default.invalidSearch();
                this.refs.searchTextField.getDOMNode().focus();
            }

            if (search) {
                _SearchActions2.default.performSearch(search);
            }
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'head row flipInX animated' },
                _react2.default.createElement(
                    'div',
                    { className: 'container' },
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { style: searchbox, className: 'input-group' },
                            _react2.default.createElement('input', { type: 'text', className: 'form-control', placeholder: 'Search',
                                ref: 'searchTextField', value: this.state.search,
                                onChange: _SearchActions2.default.updateSearch, autofocus: true }),
                            _react2.default.createElement(
                                'div',
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement('img', { style: searchStyle, src: 'img/searchicon.png', alt: '' })
                                )
                            )
                        ),
                        _react2.default.createElement(
...
},{"../../actions/SearchActions":3,"../../stores/SearchStore":19,"react":"react"}],11:[function(require,module,exports){
'use strict';
...
},{"../homepage/Search":8,"./alert":12,"./countries":13,"./imageUpload":14,"isomorphic-fetch":38,"muicss/lib/react/button":48,"muicss/lib/react/input":57,"muicss/lib/react/option":58,"muicss/lib/react/select":62,"muicss/lib/react/textarea":65,"react":"react"}],12:[function(require,module,exports){
'use strict';
...
var _AddBotStore = require('../../stores/AddBotStore');

var _AddBotStore2 = _interopRequireDefault(_AddBotStore);

var _AddBotActions = require('../../actions/AddBotActions');
...
var UploadBot = function (_React$Component) {
  _inherits(UploadBot, _React$Component);

  function UploadBot(props) {
    _classCallCheck(this, UploadBot);

    var _this = _possibleConstructorReturn(this, (UploadBot.__proto__ || Object.getPrototypeOf(UploadBot)).call(this, props));

    _this.state = _AddBotStore2.default.getState();
    _this.onChange = _this.onChange.bind(_this);
    return _this;
  }

  _createClass(UploadBot, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      _AddBotStore2.default.listen(this.onChange);
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _AddBotStore2.default.unlisten(this.onChange);
    }
  }, {
    key: 'onChange',
    value: function onChange(state) {
    ...
    value: function handleSubmit(event) {
      ...
      if (!companyname) {
        _AddBotActions2.default.invalidCompanyName();
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { type: 'text', className: 'form-control', ref: 'botNameTextField', value: this.state.botname,
                      onChange: _AddBotActions2.default.updateBotName, autoFocus: true }),
                    _react2.default.createElement(
                      'span',
                  ...
                  _react2.default.createElement(
                    'div',
                    { className: 'form-group ' + this.state.companyNameValidationState },
                    _react2.default.createElement(
                      'label',
                      { className: 'control-label' },
                      'Company Name'
                    ),
                    _react2.default.createElement('input', { type: 'text', className: 'form-control', ref: 'companyNameTextField', value: this.state.companyname,
                      onChange: _AddBotActions2.default.updateCompanyName }),
                    _react2.default.createElement(
                      'span',
                      { className: 'help-block' },
...
},{"../../actions/AddBotActions":1,"../../stores/AddBotStore":17,"./countries":13,"react":"react"}],13:[function(require,module,exports){
"use strict";
...
},{"muicss/react":66,"react":"react"}],14:[function(require,module,exports){
'use strict';
...
},{"lodash":39,"react":"react"}],15:[function(require,module,exports){
'use strict';
...
},{"./components/App":5,"./components/uploadpage/Uploadform":11,"react":"react","react-router":"react-router"}],17:[function(require,module,exports){
'use strict';
...
var AddBotStore = function () {
  function AddBotStore() {
    _classCallCheck(this, AddBotStore);
...
exports.default = _alt2.default.createStore(AddBotStore);

},{"../actions/AddBotActions":1,"../alt":4}],18:[function(require,module,exports){
'use strict';
...
},{"../actions/FooterActions":2,"../alt":4}],19:[function(require,module,exports){
'use strict';
...
var SearchStore = function () {
    ...
    _createClass(SearchStore, [{
        ...
        key: 'onInvalidSearch',
        value: function onInvalidSearch() {
            this.searchValidationState = 'has-error';
            this.searchHelpBlock = 'No results found';
        }
    }]);
...
},{"../actions/SearchActions":3,"../alt":4}],20:[function(require,module,exports){
...
},{"_process":67,"warning":69}],27:[function(require,module,exports){
'use strict';
...
},{"./Actions":24,"./DOMStateStorage":26,"./DOMUtils":27,"./ExecutionEnvironment":28,"./createDOMHistory":30,"./parsePath":35,"_process":67,"invariant":37}],30:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./DOMUtils":27,"./ExecutionEnvironment":28,"./createHistory":31,"_process":67,"invariant":37}],31:[function(require,module,exports){
...
module.exports = exports['default'];
},{"./Actions":24,"./AsyncUtils":25,"./createLocation":32,"./deprecate":33,"./parsePath":35,"./runTransitionHook":36,"deep-equal":20}],32:[function(require,module,exports){
//import warning from 'warning'
'use strict';
...
},{"./extractPath":34,"_process":67,"warning":69}],36:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":67,"warning":69}],37:[function(require,module,exports){
(function (process){
/**
...
},{"whatwg-fetch":70}],39:[function(require,module,exports){
(function (global){
/**
 * @license
...
},{"./jqLite":42}],42:[function(require,module,exports){
/**
...
},{"../config":40,"./jqLite":42}],44:[function(require,module,exports){
...
},{"./babel-helpers.js":47}],45:[function(require,module,exports){
var babelHelpers = require('./babel-helpers.js');
/**
...
},{"../js/lib/jqLite":42,"../js/lib/util":43,"./_helpers":44,"./babel-helpers.js":47,"react":"react","react-addons-shallow-compare":68}],46:[function(require,module,exports){
var babelHelpers = require('./babel-helpers.js');
/**
...
module.exports = exports['default'];
},{"./babel-helpers.js":47,"react":"react"}],47:[function(require,module,exports){
...
module.exports = exports['default'];
},{"../js/lib/jqLite":42,"../js/lib/util":43,"./babel-helpers.js":47,"react":"react"}],49:[function(require,module,exports){
var babelHelpers = require('./babel-helpers.js');
/**
...
module.exports = exports['default'];
},{"./babel-helpers.js":47,"react":"react"}],50:[function(require,module,exports){
var babelHelpers = require('./babel-helpers.js');
/**
...
module.exports = exports['default'];
},{"../js/lib/util":43,"./_helpers":44,"./babel-helpers.js":47,"react":"react"}],51:[function(require,module,exports){
var babelHelpers = require('./babel-helpers.js');
/**
...
exports.default = Col;
module.exports = exports['default'];
},{"../js/lib/util":43,"./babel-helpers.js":47,"react":"react"}],52:[function(require,module,exports){
var babelHelpers = require('./babel-helpers.js');
/**
...
module.exports = exports['default'];
},{"./babel-helpers.js":47,"react":"react"}],53:[function(require,module,exports){
var babelHelpers = require('./babel-helpers.js');
/**
...
module.exports = exports['default'];
},{"./babel-helpers.js":47,"react":"react"}],54:[function(require,module,exports){
var babelHelpers = require('./babel-helpers.js');
/**
...
module.exports = exports['default'];
},{"../js/lib/util":43,"./babel-helpers.js":47,"react":"react"}],55:[function(require,module,exports){
var babelHelpers = require('./babel-helpers.js');
/**
 * MUI React dropdowns module
 * @module react/dropdowns
...
module.exports = exports['default'];
},{"../js/lib/jqLite":42,"../js/lib/util":43,"./babel-helpers.js":47,"./button":48,"./caret":49,"react":"react"}],56:[function(require,module,exports){
var babelHelpers = require('./babel-helpers.js');
/**
...
module.exports = exports['default'];
},{"./babel-helpers.js":47,"react":"react"}],57:[function(require,module,exports){
var babelHelpers = require('./babel-helpers.js');
/**                                                                            
...
module.exports = exports['default'];
},{"./_textfieldHelpers":45,"./babel-helpers.js":47,"react":"react"}],58:[function(require,module,exports){
var babelHelpers = require('./babel-helpers.js');
/**
...
module.exports = exports['default'];
},{"../js/lib/forms":41,"../js/lib/jqLite":42,"../js/lib/util":43,"./_helpers":44,"./babel-helpers.js":47,"react":"react"}],59:[function(require,module,exports){
var babelHelpers = require('./babel-helpers.js');
/**
...
module.exports = exports['default'];
},{"./babel-helpers.js":47,"react":"react"}],60:[function(require,module,exports){
var babelHelpers = require('./babel-helpers.js');
/**
...
module.exports = exports['default'];
},{"./babel-helpers.js":47,"react":"react"}],61:[function(require,module,exports){
var babelHelpers = require('./babel-helpers.js');
/**
...
exports.default = Row;
module.exports = exports['default'];
},{"../js/lib/util":43,"./babel-helpers.js":47,"react":"react"}],62:[function(require,module,exports){
var babelHelpers = require('./babel-helpers.js');
/**
...
module.exports = exports['default'];
},{"../js/lib/forms":41,"../js/lib/jqLite":42,"../js/lib/util":43,"./_helpers":44,"./babel-helpers.js":47,"react":"react"}],63:[function(require,module,exports){
var babelHelpers = require('./babel-helpers.js');
/**
...
exports.default = Tab;
module.exports = exports['default'];
},{"./babel-helpers.js":47,"react":"react"}],64:[function(require,module,exports){
(function (process){
var babelHelpers = require('./babel-helpers.js');
/**
 * MUI React tabs module
...
},{"../js/lib/util":43,"./babel-helpers.js":47,"./tab":63,"_process":67,"react":"react"}],65:[function(require,module,exports){
var babelHelpers = require('./babel-helpers.js');
/**
...
module.exports = exports['default'];
},{"./_textfieldHelpers":45,"./babel-helpers.js":47,"react":"react"}],66:[function(require,module,exports){
/**
 * MUI NPM Package
 * @module pkg/react.js
 */
...
},{"./lib/react/appbar":46,"./lib/react/button":48,"./lib/react/caret":49,"./lib/react/checkbox":50,"./lib/react/col":51,"./lib/react/container":52,"./lib/react/divider":53,"./lib/react/dropdown":55,"./lib/react/dropdown-item":54,"./lib/react/form":56,"./lib/react/input":57,"./lib/react/option":58,"./lib/react/panel":59,"./lib/react/radio":60,"./lib/react/row":61,"./lib/react/select":62,"./lib/react/tab":63,"./lib/react/tabs":64,"./lib/react/textarea":65}],67:[function(require,module,exports){
...
},{"fbjs/lib/shallowEqual":23}],69:[function(require,module,exports){
(function (process){
/**
